...
class Header : public ::google::protobuf::Message {
 public:
  ...
  inline const ::apollo::common::StatusPb& status() const;
  inline ::apollo::common::StatusPb* mutable_status();
  inline ::apollo::common::StatusPb* release_status();
  inline void set_allocated_status(::apollo::common::StatusPb* status);
...
inline ::apollo::common::StatusPb* Header::mutable_status() {
  set_has_status();
  if (status_ == NULL) status_ = new ::apollo::common::StatusPb;
