...
#ifndef PROTOBUF_conti_5fradar_5fconf_2eproto__INCLUDED
#define PROTOBUF_conti_5fradar_5fconf_2eproto__INCLUDED
...
class CanConf : public ::google::protobuf::Message {
 public:
  CanConf();
  virtual ~CanConf();
  ...
  inline bool has_can_card_parameter() const;
  inline void clear_can_card_parameter();
  static const int kCanCardParameterFieldNumber = 1;
  inline const ::apollo::drivers::canbus::CANCardParameter& can_card_parameter() const;
  inline ::apollo::drivers::canbus::CANCardParameter* mutable_can_card_parameter();
  inline ::apollo::drivers::canbus::CANCardParameter* release_can_card_parameter();
  inline void set_allocated_can_card_parameter(::apollo::drivers::canbus::CANCardParameter* can_card_parameter);

  // optional bool enable_debug_mode = 2 [default = false];
  inline bool has_enable_debug_mode() const;
  inline void clear_enable_debug_mode();
  static const int kEnableDebugModeFieldNumber = 2;
  inline bool enable_debug_mode() const;
  inline void set_enable_debug_mode(bool value);

  // optional bool enable_receiver_log = 3 [default = false];
  inline bool has_enable_receiver_log() const;
  inline void clear_enable_receiver_log();
  static const int kEnableReceiverLogFieldNumber = 3;
  inline bool enable_receiver_log() const;
  inline void set_enable_receiver_log(bool value);

  // optional bool enable_sender_log = 4 [default = false];
  inline bool has_enable_sender_log() const;
  inline void clear_enable_sender_log();
  static const int kEnableSenderLogFieldNumber = 4;
  inline bool enable_sender_log() const;
  inline void set_enable_sender_log(bool value);
 ...
 private:
  ...
  friend void  protobuf_AddDesc_conti_5fradar_5fconf_2eproto();
  friend void protobuf_AssignDesc_conti_5fradar_5fconf_2eproto();
  friend void protobuf_ShutdownFile_conti_5fradar_5fconf_2eproto();
...
class RadarConf : public ::google::protobuf::Message {
 public:
  RadarConf();
  virtual ~RadarConf();
  ...
  inline bool has_max_distance_valid() const;
  inline void clear_max_distance_valid();
  static const int kMaxDistanceValidFieldNumber = 1;
  inline bool max_distance_valid() const;
  inline void set_max_distance_valid(bool value);

  // optional bool sensor_id_valid = 2 [default = false];
  inline bool has_sensor_id_valid() const;
  inline void clear_sensor_id_valid();
  static const int kSensorIdValidFieldNumber = 2;
  inline bool sensor_id_valid() const;
  inline void set_sensor_id_valid(bool value);

  // optional bool radar_power_valid = 3 [default = false];
  inline bool has_radar_power_valid() const;
  inline void clear_radar_power_valid();
  static const int kRadarPowerValidFieldNumber = 3;
  inline bool radar_power_valid() const;
  inline void set_radar_power_valid(bool value);

  // optional bool output_type_valid = 4 [default = true];
  inline bool has_output_type_valid() const;
  inline void clear_output_type_valid();
  static const int kOutputTypeValidFieldNumber = 4;
  inline bool output_type_valid() const;
  inline void set_output_type_valid(bool value);

  // optional bool send_quality_valid = 5 [default = true];
  inline bool has_send_quality_valid() const;
  inline void clear_send_quality_valid();
  static const int kSendQualityValidFieldNumber = 5;
  inline bool send_quality_valid() const;
  inline void set_send_quality_valid(bool value);

  // optional bool send_ext_info_valid = 6 [default = true];
  inline bool has_send_ext_info_valid() const;
  inline void clear_send_ext_info_valid();
  static const int kSendExtInfoValidFieldNumber = 6;
  inline bool send_ext_info_valid() const;
  inline void set_send_ext_info_valid(bool value);

  // optional bool sort_index_valid = 7 [default = false];
  inline bool has_sort_index_valid() const;
  inline void clear_sort_index_valid();
  static const int kSortIndexValidFieldNumber = 7;
  inline bool sort_index_valid() const;
  inline void set_sort_index_valid(bool value);

  // optional bool store_in_nvm_valid = 8 [default = true];
  inline bool has_store_in_nvm_valid() const;
  inline void clear_store_in_nvm_valid();
  static const int kStoreInNvmValidFieldNumber = 8;
  inline bool store_in_nvm_valid() const;
  inline void set_store_in_nvm_valid(bool value);

  // optional bool ctrl_relay_valid = 9 [default = false];
  inline bool has_ctrl_relay_valid() const;
  inline void clear_ctrl_relay_valid();
  static const int kCtrlRelayValidFieldNumber = 9;
  inline bool ctrl_relay_valid() const;
  inline void set_ctrl_relay_valid(bool value);

  // optional bool rcs_threshold_valid = 10 [default = true];
  inline bool has_rcs_threshold_valid() const;
  inline void clear_rcs_threshold_valid();
  static const int kRcsThresholdValidFieldNumber = 10;
  inline bool rcs_threshold_valid() const;
  inline void set_rcs_threshold_valid(bool value);
  ...
  inline ::google::protobuf::uint32 sensor_id() const;
  inline void set_sensor_id(::google::protobuf::uint32 value);
  ...
  inline bool has_ctrl_relay() const;
  inline void clear_ctrl_relay();
  static const int kCtrlRelayFieldNumber = 15;
  inline ::google::protobuf::uint32 ctrl_relay() const;
  inline void set_ctrl_relay(::google::protobuf::uint32 value);
  ...
  inline bool has_sort_index() const;
  inline void clear_sort_index();
  static const int kSortIndexFieldNumber = 18;
  inline ::google::protobuf::uint32 sort_index() const;
  inline void set_sort_index(::google::protobuf::uint32 value);

  // optional uint32 store_in_nvm = 19 [default = 1];
  inline bool has_store_in_nvm() const;
  inline void clear_store_in_nvm();
  static const int kStoreInNvmFieldNumber = 19;
  inline ::google::protobuf::uint32 store_in_nvm() const;
  inline void set_store_in_nvm(::google::protobuf::uint32 value);
  ...
  inline bool has_input_send_interval() const;
  inline void clear_input_send_interval();
  static const int kInputSendIntervalFieldNumber = 21;
  inline ::google::protobuf::uint64 input_send_interval() const;
  inline void set_input_send_interval(::google::protobuf::uint64 value);
 ...
 private:
  ...
  inline void set_has_input_send_interval();
  inline void clear_has_input_send_interval();
...
class ContiRadarConf : public ::google::protobuf::Message {
 public:
  ContiRadarConf();
  ...
  inline bool has_can_conf() const;
  inline void clear_can_conf();
  static const int kCanConfFieldNumber = 1;
  inline const ::apollo::drivers::conti_radar::CanConf& can_conf() const;
  inline ::apollo::drivers::conti_radar::CanConf* mutable_can_conf();
  inline ::apollo::drivers::conti_radar::CanConf* release_can_conf();
  inline void set_allocated_can_conf(::apollo::drivers::conti_radar::CanConf* can_conf);

  // optional .apollo.drivers.conti_radar.RadarConf radar_conf = 2;
  inline bool has_radar_conf() const;
  inline void clear_radar_conf();
  static const int kRadarConfFieldNumber = 2;
  inline const ::apollo::drivers::conti_radar::RadarConf& radar_conf() const;
  inline ::apollo::drivers::conti_radar::RadarConf* mutable_radar_conf();
  inline ::apollo::drivers::conti_radar::RadarConf* release_radar_conf();
  inline void set_allocated_radar_conf(::apollo::drivers::conti_radar::RadarConf* radar_conf);

  // optional string radar_channel = 3;
  inline bool has_radar_channel() const;
  inline void clear_radar_channel();
  static const int kRadarChannelFieldNumber = 3;
  inline const ::std::string& radar_channel() const;
  inline void set_radar_channel(const ::std::string& value);
  inline void set_radar_channel(const char* value);
  inline void set_radar_channel(const char* value, size_t size);
  inline ::std::string* mutable_radar_channel();
  inline ::std::string* release_radar_channel();
  inline void set_allocated_radar_channel(::std::string* radar_channel);
...
inline ::apollo::drivers::canbus::CANCardParameter* CanConf::mutable_can_card_parameter() {
  ...
  if (can_card_parameter_ == NULL) can_card_parameter_ = new ::apollo::drivers::canbus::CANCardParameter;
...
inline ::apollo::drivers::conti_radar::CanConf* ContiRadarConf::mutable_can_conf() {
  set_has_can_conf();
  if (can_conf_ == NULL) can_conf_ = new ::apollo::drivers::conti_radar::CanConf;
...
inline ::apollo::drivers::conti_radar::RadarConf* ContiRadarConf::mutable_radar_conf() {
  set_has_radar_conf();
  if (radar_conf_ == NULL) radar_conf_ = new ::apollo::drivers::conti_radar::RadarConf;
...
inline void ContiRadarConf::set_radar_channel(const char* value, size_t size) {
  ...
  radar_channel_->assign(reinterpret_cast<const char*>(value), size);
...
inline ::std::string* ContiRadarConf::release_radar_channel() {
  ...
  if (radar_channel_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    ...
    ::std::string* temp = radar_channel_;
...
#endif  // PROTOBUF_conti_5fradar_5fconf_2eproto__INCLUDED
