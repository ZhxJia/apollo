...
#ifndef PROTOBUF_conti_5fradar_2eproto__INCLUDED
#define PROTOBUF_conti_5fradar_2eproto__INCLUDED
...
class ClusterListStatus_600 : public ::google::protobuf::Message {
 public:
  ...
  ClusterListStatus_600* New() const;
  ...
  inline ::google::protobuf::int32 near() const;
  inline void set_near(::google::protobuf::int32 value);

  // optional int32 far = 2 [default = 0];
  inline bool has_far() const;
  inline void clear_far();
  static const int kFarFieldNumber = 2;
  inline ::google::protobuf::int32 far() const;
  inline void set_far(::google::protobuf::int32 value);

  // optional int32 meas_counter = 3 [default = -1];
  inline bool has_meas_counter() const;
  inline void clear_meas_counter();
  static const int kMeasCounterFieldNumber = 3;
  inline ::google::protobuf::int32 meas_counter() const;
  inline void set_meas_counter(::google::protobuf::int32 value);
  ...
  inline ::google::protobuf::int32 interface_version() const;
  inline void set_interface_version(::google::protobuf::int32 value);
 ...
 private:
  ...
  friend void  protobuf_AddDesc_conti_5fradar_2eproto();
  friend void protobuf_AssignDesc_conti_5fradar_2eproto();
  friend void protobuf_ShutdownFile_conti_5fradar_2eproto();
...
class ObjectListStatus_60A : public ::google::protobuf::Message {
 public:
  ...
  ObjectListStatus_60A* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  inline bool has_nof_objects() const;
  inline void clear_nof_objects();
  static const int kNofObjectsFieldNumber = 1;
  inline ::google::protobuf::int32 nof_objects() const;
  inline void set_nof_objects(::google::protobuf::int32 value);
...
class RadarState_201 : public ::google::protobuf::Message {
 public:
  RadarState_201();
  ...
  inline bool has_radar_power() const;
  inline void clear_radar_power();
  static const int kRadarPowerFieldNumber = 2;
  inline ::google::protobuf::uint32 radar_power() const;
  inline void set_radar_power(::google::protobuf::uint32 value);
  ...
  inline ::apollo::drivers::conti_radar::OutputType output_type() const;
  inline void set_output_type(::apollo::drivers::conti_radar::OutputType value);

  // optional .apollo.drivers.conti_radar.RcsThreshold rcs_threshold = 4;
  inline bool has_rcs_threshold() const;
  inline void clear_rcs_threshold();
  static const int kRcsThresholdFieldNumber = 4;
  inline ::apollo::drivers::conti_radar::RcsThreshold rcs_threshold() const;
  inline void set_rcs_threshold(::apollo::drivers::conti_radar::RcsThreshold value);

  // optional bool send_quality = 5;
  inline bool has_send_quality() const;
  inline void clear_send_quality();
  static const int kSendQualityFieldNumber = 5;
  inline bool send_quality() const;
  inline void set_send_quality(bool value);

  // optional bool send_ext_info = 6;
  inline bool has_send_ext_info() const;
  inline void clear_send_ext_info();
  static const int kSendExtInfoFieldNumber = 6;
  inline bool send_ext_info() const;
  inline void set_send_ext_info(bool value);
...
class ContiRadarObs : public ::google::protobuf::Message {
 public:
  ContiRadarObs();
  ...
  inline bool has_clusterortrack() const;
  inline void clear_clusterortrack();
  static const int kClusterortrackFieldNumber = 2;
  inline bool clusterortrack() const;
  inline void set_clusterortrack(bool value);

  // optional int32 obstacle_id = 3;
  inline bool has_obstacle_id() const;
  inline void clear_obstacle_id();
  static const int kObstacleIdFieldNumber = 3;
  inline ::google::protobuf::int32 obstacle_id() const;
  inline void set_obstacle_id(::google::protobuf::int32 value);

  // optional double longitude_dist = 4;
  inline bool has_longitude_dist() const;
  inline void clear_longitude_dist();
  static const int kLongitudeDistFieldNumber = 4;
  inline double longitude_dist() const;
  inline void set_longitude_dist(double value);

  // optional double lateral_dist = 5;
  inline bool has_lateral_dist() const;
  inline void clear_lateral_dist();
  static const int kLateralDistFieldNumber = 5;
  inline double lateral_dist() const;
  inline void set_lateral_dist(double value);

  // optional double longitude_vel = 6;
  inline bool has_longitude_vel() const;
  inline void clear_longitude_vel();
  static const int kLongitudeVelFieldNumber = 6;
  inline double longitude_vel() const;
  inline void set_longitude_vel(double value);

  // optional double lateral_vel = 7;
  inline bool has_lateral_vel() const;
  inline void clear_lateral_vel();
  static const int kLateralVelFieldNumber = 7;
  inline double lateral_vel() const;
  inline void set_lateral_vel(double value);

  // optional double rcs = 8;
  inline bool has_rcs() const;
  inline void clear_rcs();
  static const int kRcsFieldNumber = 8;
  inline double rcs() const;
  inline void set_rcs(double value);

  // optional int32 dynprop = 9;
  inline bool has_dynprop() const;
  inline void clear_dynprop();
  static const int kDynpropFieldNumber = 9;
  inline ::google::protobuf::int32 dynprop() const;
  inline void set_dynprop(::google::protobuf::int32 value);

  // optional double longitude_dist_rms = 10;
  inline bool has_longitude_dist_rms() const;
  inline void clear_longitude_dist_rms();
  static const int kLongitudeDistRmsFieldNumber = 10;
  inline double longitude_dist_rms() const;
  inline void set_longitude_dist_rms(double value);

  // optional double lateral_dist_rms = 11;
  inline bool has_lateral_dist_rms() const;
  inline void clear_lateral_dist_rms();
  static const int kLateralDistRmsFieldNumber = 11;
  inline double lateral_dist_rms() const;
  inline void set_lateral_dist_rms(double value);

  // optional double longitude_vel_rms = 12;
  inline bool has_longitude_vel_rms() const;
  inline void clear_longitude_vel_rms();
  static const int kLongitudeVelRmsFieldNumber = 12;
  inline double longitude_vel_rms() const;
  inline void set_longitude_vel_rms(double value);

  // optional double lateral_vel_rms = 13;
  inline bool has_lateral_vel_rms() const;
  inline void clear_lateral_vel_rms();
  static const int kLateralVelRmsFieldNumber = 13;
  inline double lateral_vel_rms() const;
  inline void set_lateral_vel_rms(double value);

  // optional double probexist = 14;
  inline bool has_probexist() const;
  inline void clear_probexist();
  static const int kProbexistFieldNumber = 14;
  inline double probexist() const;
  inline void set_probexist(double value);

  // optional int32 meas_state = 15;
  inline bool has_meas_state() const;
  inline void clear_meas_state();
  static const int kMeasStateFieldNumber = 15;
  inline ::google::protobuf::int32 meas_state() const;
  inline void set_meas_state(::google::protobuf::int32 value);

  // optional double longitude_accel = 16;
  inline bool has_longitude_accel() const;
  inline void clear_longitude_accel();
  static const int kLongitudeAccelFieldNumber = 16;
  inline double longitude_accel() const;
  inline void set_longitude_accel(double value);

  // optional double lateral_accel = 17;
  inline bool has_lateral_accel() const;
  inline void clear_lateral_accel();
  static const int kLateralAccelFieldNumber = 17;
  inline double lateral_accel() const;
  inline void set_lateral_accel(double value);

  // optional double oritation_angle = 18;
  inline bool has_oritation_angle() const;
  inline void clear_oritation_angle();
  static const int kOritationAngleFieldNumber = 18;
  inline double oritation_angle() const;
  inline void set_oritation_angle(double value);

  // optional double longitude_accel_rms = 19;
  inline bool has_longitude_accel_rms() const;
  inline void clear_longitude_accel_rms();
  static const int kLongitudeAccelRmsFieldNumber = 19;
  inline double longitude_accel_rms() const;
  inline void set_longitude_accel_rms(double value);

  // optional double lateral_accel_rms = 20;
  inline bool has_lateral_accel_rms() const;
  inline void clear_lateral_accel_rms();
  static const int kLateralAccelRmsFieldNumber = 20;
  inline double lateral_accel_rms() const;
  inline void set_lateral_accel_rms(double value);

  // optional double oritation_angle_rms = 21;
  inline bool has_oritation_angle_rms() const;
  inline void clear_oritation_angle_rms();
  static const int kOritationAngleRmsFieldNumber = 21;
  inline double oritation_angle_rms() const;
  inline void set_oritation_angle_rms(double value);
  ...
  inline bool has_obstacle_class() const;
  inline void clear_obstacle_class();
  static const int kObstacleClassFieldNumber = 24;
  inline ::google::protobuf::int32 obstacle_class() const;
  inline void set_obstacle_class(::google::protobuf::int32 value);
...
class ContiRadar : public ::google::protobuf::Message {
 public:
  ContiRadar();
  virtual ~ContiRadar();
  ...
  inline int contiobs_size() const;
  inline void clear_contiobs();
  static const int kContiobsFieldNumber = 2;
  inline const ::apollo::drivers::ContiRadarObs& contiobs(int index) const;
  inline ::apollo::drivers::ContiRadarObs* mutable_contiobs(int index);
  inline ::apollo::drivers::ContiRadarObs* add_contiobs();
  ...
  inline bool has_radar_state() const;
  inline void clear_radar_state();
  static const int kRadarStateFieldNumber = 3;
  inline const ::apollo::drivers::RadarState_201& radar_state() const;
  inline ::apollo::drivers::RadarState_201* mutable_radar_state();
  inline ::apollo::drivers::RadarState_201* release_radar_state();
  inline void set_allocated_radar_state(::apollo::drivers::RadarState_201* radar_state);

  // optional .apollo.drivers.ClusterListStatus_600 cluster_list_status = 4;
  inline bool has_cluster_list_status() const;
  inline void clear_cluster_list_status();
  static const int kClusterListStatusFieldNumber = 4;
  inline const ::apollo::drivers::ClusterListStatus_600& cluster_list_status() const;
  inline ::apollo::drivers::ClusterListStatus_600* mutable_cluster_list_status();
  inline ::apollo::drivers::ClusterListStatus_600* release_cluster_list_status();
  inline void set_allocated_cluster_list_status(::apollo::drivers::ClusterListStatus_600* cluster_list_status);

  // optional .apollo.drivers.ObjectListStatus_60A object_list_status = 5;
  inline bool has_object_list_status() const;
  inline void clear_object_list_status();
  static const int kObjectListStatusFieldNumber = 5;
  inline const ::apollo::drivers::ObjectListStatus_60A& object_list_status() const;
  inline ::apollo::drivers::ObjectListStatus_60A* mutable_object_list_status();
  inline ::apollo::drivers::ObjectListStatus_60A* release_object_list_status();
  inline void set_allocated_object_list_status(::apollo::drivers::ObjectListStatus_60A* object_list_status);
...
inline ::apollo::drivers::RadarState_201* ContiRadar::mutable_radar_state() {
  set_has_radar_state();
  if (radar_state_ == NULL) radar_state_ = new ::apollo::drivers::RadarState_201;
...
inline ::apollo::drivers::ClusterListStatus_600* ContiRadar::mutable_cluster_list_status() {
  ...
  if (cluster_list_status_ == NULL) cluster_list_status_ = new ::apollo::drivers::ClusterListStatus_600;
...
inline ::apollo::drivers::ObjectListStatus_60A* ContiRadar::mutable_object_list_status() {
  ...
  if (object_list_status_ == NULL) object_list_status_ = new ::apollo::drivers::ObjectListStatus_60A;
...
#endif  // PROTOBUF_conti_5fradar_2eproto__INCLUDED
